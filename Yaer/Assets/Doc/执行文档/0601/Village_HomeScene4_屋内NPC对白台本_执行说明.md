...
**建议资源名**：`Village_HomeScene4_Npc2_3_First`
...
**建议资源名**：`Village_HomeScene4_Npc2_Repeat`  
...
**建议资源名**：`Village_HomeScene4_Npc4_5`
...
|----------|----------------------|----------------------|
| 屋子里的 NPC1 | `Entity/Npc1` | `Village_HomeScene4_Npc1` |
| NPC2 | `Entity/Npc2` | 首次：`Village_HomeScene4_Npc2_3_First`；再点：`Village_HomeScene4_Npc2_Repeat` |
| NPC3 | `Entity/Npc3` | 与 NPC2 同一段首次剧情（挂在 NPC3 或只挂 NPC2 其一，避免重复触发） |
| NPC4 | `Entity/Npc4` | `Village_HomeScene4_Npc4_5` |
...
4. 从 **InitScene** 进游戏，进 `Village_HomeScene4`，逐个点 NPC 验收台词顺序。

更细的 NPC 挂载说明见：`Village_HomeScene4_NPC对话配置_执行说明.md`。
...
**路径**：`Assets/Doc/执行文档/0601/Village_HomeScene4_屋内NPC对白台本_执行说明.md`
