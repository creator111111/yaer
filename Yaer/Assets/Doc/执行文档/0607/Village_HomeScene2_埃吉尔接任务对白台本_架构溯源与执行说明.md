...
- NPC 配置样板：`Assets/Doc/执行文档/0601/Village_HomeScene4_NPC对话配置_执行说明.md`
...
6. 保留 `EntityControl`（`entityType=NPC`，`canTouchWithPlayer=true`）、`InteractiveComponent`、Body 触发碰撞（照 `Village_HomeScene4_NPC对话配置_执行说明.md` §4.3）。
...
| NPC 三件套 | `0601/Village_HomeScene4_NPC对话配置_执行说明.md` |
