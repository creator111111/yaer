...
namespace GameFramework.UnityRuntime.Config
{
    /// <summary>
    /// 加载全局配置时加载依赖资源事件。
    /// </summary>
    public sealed class LoadConfigDependencyAssetEventArgs : GameEventArgs
    {
        ...
        {
            LoadConfigDependencyAssetEventArgs loadConfigDependencyAssetEventArgs = GameFramework.ReferencePool.Acquire<LoadConfigDependencyAssetEventArgs>();
