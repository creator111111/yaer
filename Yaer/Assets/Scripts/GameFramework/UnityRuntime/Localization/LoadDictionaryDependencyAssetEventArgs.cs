...
namespace GameFramework.UnityRuntime.Localization
{
    /// <summary>
    /// 加载字典时加载依赖资源事件。
    /// </summary>
    public sealed class LoadDictionaryDependencyAssetEventArgs : GameEventArgs
    {
        ...
        {
            LoadDictionaryDependencyAssetEventArgs loadDictionaryDependencyAssetEventArgs = GameFramework.ReferencePool.Acquire<LoadDictionaryDependencyAssetEventArgs>();
