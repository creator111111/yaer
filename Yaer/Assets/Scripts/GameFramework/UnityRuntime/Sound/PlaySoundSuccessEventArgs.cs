...
namespace GameFramework.UnityRuntime.Sound
{
    ...
    public sealed class PlaySoundSuccessEventArgs : GameEventArgs
    {
        ...
        public static PlaySoundSuccessEventArgs Create(GameFramework.Sound.PlaySoundSuccessEventArgs e)
        {
            ...
            PlaySoundSuccessEventArgs playSoundSuccessEventArgs = GameFramework.ReferencePool.Acquire<PlaySoundSuccessEventArgs>();
            ...
            GameFramework.ReferencePool.Release(playSoundInfo);
