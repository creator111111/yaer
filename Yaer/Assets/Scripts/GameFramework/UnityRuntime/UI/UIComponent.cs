...
namespace GameFramework.UnityRuntime.UI
{
    /// <summary>
    /// 界面组件。
    /// </summary>
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_UIFormHelperTypeName = "GameFramework.UnityRuntime.DefaultUIFormHelper";

        [SerializeField]
        private UIFormHelperBase m_CustomUIFormHelper = null;

        [SerializeField]
        private string m_UIGroupHelperTypeName = "GameFramework.UnityRuntime.DefaultUIGroupHelper";
        ...
        public bool AddUIGroup(string uiGroupName, int depth)
        {
            ...
            uiGroupHelper.name = GameFramework.Utility.Text.Format("UI Group - {0}", uiGroupName);
