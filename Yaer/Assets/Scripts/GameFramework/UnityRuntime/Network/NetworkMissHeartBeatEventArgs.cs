...
namespace GameFramework.UnityRuntime.Network
{
    /// <summary>
    /// 网络心跳包丢失事件。
    /// </summary>
    public sealed class NetworkMissHeartBeatEventArgs : GameEventArgs
    {
        ...
        {
            NetworkMissHeartBeatEventArgs networkMissHeartBeatEventArgs = GameFramework.ReferencePool.Acquire<NetworkMissHeartBeatEventArgs>();
