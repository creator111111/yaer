...
namespace GameFramework.UnityRuntime.WebRequest
{
    ...
    public sealed class WebRequestComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_WebRequestAgentHelperTypeName = "GameFramework.UnityRuntime.UnityWebRequestAgentHelper";
        ...
        private void AddWebRequestAgentHelper(int index)
        {
            ...
            webRequestAgentHelper.name = GameFramework.Utility.Text.Format("Web Request Agent Helper - {0}", index.ToString());
