...
namespace GameFramework.UnityRuntime.WebRequest
{
    ...
    public sealed class WebRequestSuccessEventArgs : GameEventArgs
    {
        ...
        public static WebRequestSuccessEventArgs Create(GameFramework.WebRequest.WebRequestSuccessEventArgs e)
        {
            ...
            WebRequestSuccessEventArgs webRequestSuccessEventArgs = GameFramework.ReferencePool.Acquire<WebRequestSuccessEventArgs>();
            ...
            GameFramework.ReferencePool.Release(wwwFormInfo);
