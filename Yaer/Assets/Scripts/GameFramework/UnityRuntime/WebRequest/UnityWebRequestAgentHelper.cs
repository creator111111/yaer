...
namespace GameFramework.UnityRuntime.WebRequest
{
    /// <summary>
    ...
    public class UnityWebRequestAgentHelper : WebRequestAgentHelperBase, IDisposable
    {
        ...
        public override void Request(string webRequestUri, byte[] postData, object userData)
        {
            ...
            m_UnityWebRequest = UnityWebRequest.Post(webRequestUri, GameFramework.Utility.Converter.GetString(postData));
#if UNITY_2017_2_OR_NEWER
            m_UnityWebRequest.SendWebRequest();
#else
            m_UnityWebRequest.Send();
        ...
        private void Update()
        {
            ...
            if (isError)
            {
                ...
                GameFramework.ReferencePool.Release(webRequestAgentHelperErrorEventArgs);
            }
            else if (m_UnityWebRequest.downloadHandler.isDone)
            {
                ...
                GameFramework.ReferencePool.Release(webRequestAgentHelperCompleteEventArgs);
            }
        }
    }
}
