...
namespace GameFramework.UnityRuntime.DataTable
{
    /// <summary>
    /// 加载数据表时加载依赖资源事件。
    /// </summary>
    public sealed class LoadDataTableDependencyAssetEventArgs : GameEventArgs
    {
        ...
        {
            LoadDataTableDependencyAssetEventArgs loadDataTableDependencyAssetEventArgs = GameFramework.ReferencePool.Acquire<LoadDataTableDependencyAssetEventArgs>();
