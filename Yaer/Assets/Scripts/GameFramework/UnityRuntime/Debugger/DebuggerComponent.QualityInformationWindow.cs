        ...
        private sealed class QualityInformationWindow : ScrollableDebuggerWindowBase
        {
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Async Upload Time Slice", GameFramework.Utility.Text.Format("{0} ms", QualitySettings.asyncUploadTimeSlice.ToString()));
                    DrawItem("Async Upload Buffer Size", GameFramework.Utility.Text.Format("{0} MB", QualitySettings.asyncUploadBufferSize.ToString()));
