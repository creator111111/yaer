...
namespace GameFramework.UnityRuntime.Debugger
{
    ...
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        private void DrawDebuggerWindowGroup(IDebuggerWindowGroup debuggerWindowGroup)
        {
            ...
            {
                names.Add(GameFramework.Utility.Text.Format("<b>{0}</b>", debuggerWindowNames[i]));
            }
        ...
        private void DrawDebuggerWindowIcon(int windowId)
        {
            ...
            string title = GameFramework.Utility.Text.Format("<color=#{0}{1}{2}{3}><b>FPS: {4}</b></color>", color.r.ToString("x2"), color.g.ToString("x2"), color.b.ToString("x2"), color.a.ToString("x2"), m_FpsCounter.CurrentFps.ToString("F2"));
