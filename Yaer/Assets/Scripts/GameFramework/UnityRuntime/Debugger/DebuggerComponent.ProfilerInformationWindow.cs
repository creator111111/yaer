        ...
        private sealed class ProfilerInformationWindow : ScrollableDebuggerWindowBase
        {
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Enable Binary Log", Profiler.enableBinaryLog ? GameFramework.Utility.Text.Format("True, {0}", Profiler.logFile) : "False");
...
#endif
                    DrawItem("Marshal Cached HGlobal Size", GetByteLengthString(GameFramework.Utility.Marshal.CachedHGlobalSize));
                }
