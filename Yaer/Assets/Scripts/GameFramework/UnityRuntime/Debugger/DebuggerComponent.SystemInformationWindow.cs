        ...
        private sealed class SystemInformationWindow : ScrollableDebuggerWindowBase
        {
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Processor Frequency", GameFramework.Utility.Text.Format("{0} MHz", SystemInfo.processorFrequency.ToString()));
                    DrawItem("System Memory Size", GameFramework.Utility.Text.Format("{0} MB", SystemInfo.systemMemorySize.ToString()));
