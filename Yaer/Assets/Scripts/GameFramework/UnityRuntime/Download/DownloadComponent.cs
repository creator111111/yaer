...
namespace GameFramework.UnityRuntime.Download
{
    ...
    public sealed class DownloadComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_DownloadAgentHelperTypeName = "GameFramework.UnityRuntime.UnityWebRequestDownloadAgentHelper";
        ...
        private void AddDownloadAgentHelper(int index)
        {
            ...
            downloadAgentHelper.name = GameFramework.Utility.Text.Format("Download Agent Helper - {0}", index.ToString());
