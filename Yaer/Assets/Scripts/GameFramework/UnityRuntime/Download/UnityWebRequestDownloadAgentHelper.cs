...
namespace GameFramework.UnityRuntime.Download
{
    ...
    public partial class UnityWebRequestDownloadAgentHelper : DownloadAgentHelperBase, IDisposable
    {
        ...
        public override void Download(string downloadUri, long fromPosition, object userData)
        {
            ...
            m_UnityWebRequest = new UnityWebRequest(downloadUri);
            m_UnityWebRequest.SetRequestHeader("Range", GameFramework.Utility.Text.Format("bytes={0}-", fromPosition.ToString()));
            m_UnityWebRequest.downloadHandler = new DownloadHandler(this);
#if UNITY_2017_2_OR_NEWER
            m_UnityWebRequest.SendWebRequest();
#else
        ...
        public override void Download(string downloadUri, long fromPosition, long toPosition, object userData)
        {
            ...
            m_UnityWebRequest = new UnityWebRequest(downloadUri);
            m_UnityWebRequest.SetRequestHeader("Range", GameFramework.Utility.Text.Format("bytes={0}-{1}", fromPosition.ToString(), toPosition.ToString()));
            m_UnityWebRequest.downloadHandler = new DownloadHandler(this);
#if UNITY_2017_2_OR_NEWER
            m_UnityWebRequest.SendWebRequest();
#else
        ...
        private void Update()
        {
            ...
            if (isError)
            {
                ...
                GameFramework.ReferencePool.Release(downloadAgentHelperErrorEventArgs);
            }
            else
            {
                ...
                GameFramework.ReferencePool.Release(downloadAgentHelperCompleteEventArgs);
            }
        }
    }
}
