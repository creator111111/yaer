...
namespace GameFramework.UnityRuntime.ReferencePool
{
    /// <summary>
    /// 基础组件。
    /// </summary>
    ...
    public sealed class ReferencePoolComponent : GameFrameworkComponent
    {
        ...
        public bool EnableStrictCheck
        {
            get
            {
                return GameFramework.ReferencePool.EnableStrictCheck;
            }
            set
            {
                GameFramework.ReferencePool.EnableStrictCheck = value;
                if (value)
                {
