...
namespace GameFramework.UnityRuntime.DataNode
{
    /// <summary>
    /// 数据结点组件。
    /// </summary>
    ...
    public sealed class DataNodeComponent : GameFrameworkComponent
    {
        ...
        public T GetData<T>(string path) where T : GameFramework.Variable
        {
        ...
        public GameFramework.Variable GetData(string path)
        {
        ...
        /// <returns>指定类型的数据。</returns>
        public T GetData<T>(string path, IDataNode node) where T : GameFramework.Variable
        {
        ...
        /// <param name="node">查找起始结点。</param>
        /// <returns>数据结点的数据。</returns>
        public GameFramework.Variable GetData(string path, IDataNode node)
        {
        ...
        public void SetData<T>(string path, T data) where T : GameFramework.Variable
        {
        ...
        /// <param name="path">相对于 node 的查找路径。</param>
        /// <param name="data">要设置的数据。</param>
        public void SetData(string path, GameFramework.Variable data)
        {
            m_DataNodeManager.SetData(path, data);
        }
        ...
        /// <param name="data">要设置的数据。</param>
        /// <param name="node">查找起始结点。</param>
        public void SetData<T>(string path, T data, IDataNode node) where T : GameFramework.Variable
        {
        ...
        /// <param name="data">要设置的数据。</param>
        /// <param name="node">查找起始结点。</param>
        public void SetData(string path, GameFramework.Variable data, IDataNode node)
        {
            m_DataNodeManager.SetData(path, data, node);
        }
