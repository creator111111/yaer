...
namespace GameFramework.UnityRuntime.Entity
{
    ...
    [AddComponentMenu("Game Framework/EntityComponent")]
    public sealed partial class EntityComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "GameFramework.UnityRuntime.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "GameFramework.UnityRuntime.DefaultEntityGroupHelper";
        ...
        public bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority)
        {
            ...
            entityGroupHelper.name = GameFramework.Utility.Text.Format("Entity Group - {0}", entityGroupName);
        ...
        public void ShowEntity(int entityId, Type entityLogicType, string entityAssetName, string entityGroupName, int priority, object userData)
        {
            ...
            m_EntityManager.ShowEntity(entityId, entityAssetName, entityGroupName, priority, ShowEntityInfo.Create(entityLogicType, entityId, userData));
        }
