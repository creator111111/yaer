...
namespace GameFramework.UnityRuntime.Entity
{
    ...
    public sealed class ShowEntitySuccessEventArgs : GameEventArgs
    {
        ...
        public static ShowEntitySuccessEventArgs Create(GameFramework.Entity.ShowEntitySuccessEventArgs e)
        {
            ...
            ShowEntitySuccessEventArgs showEntitySuccessEventArgs = GameFramework.ReferencePool.Acquire<ShowEntitySuccessEventArgs>();
            ...
            showEntitySuccessEventArgs.EntityId = showEntityInfo.EntityID;
            GameFramework.ReferencePool.Release(showEntityInfo);
