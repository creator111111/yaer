...
namespace GameFramework.UnityRuntime.FileSystem
{
    /// <summary>
    /// 安卓文件系统流。
    /// </summary>
    public sealed class AndroidFileSystemStream : FileSystemStream
    {
        ...
        public AndroidFileSystemStream(string fullPath, FileSystemAccess access, bool createNew)
        {
            ...
            {
                throw new GameFrameworkException(GameFramework.Utility.Text.Format("'{0}' is not supported in AndroidFileSystemStream.", access.ToString()));
            }
            ...
            {
                throw new GameFrameworkException(GameFramework.Utility.Text.Format("Open file '{0}' from Android asset manager failure.", fullPath));
            }
