...
namespace GameFramework.UnityRuntime.Resource
{
    /// <summary>
    /// 默认加载资源代理辅助器。
    /// </summary>
    public class DefaultLoadResourceAgentHelper : LoadResourceAgentHelperBase, IDisposable
    {
        ...
        public override void ReadBytes(IFileSystem fileSystem, string name)
        {
            ...
            GameFramework.ReferencePool.Release(loadResourceAgentHelperReadBytesCompleteEventArgs);
        }
        ...
        public override void LoadAsset(object resource, string assetName, Type assetType, bool isScene)
        {
            ...
            if (assetBundle == null)
            {
                ...
                GameFramework.ReferencePool.Release(loadResourceAgentHelperErrorEventArgs);
                return;
            }
            ...
            if (isScene)
            {
                ...
                {
                    LoadResourceAgentHelperErrorEventArgs loadResourceAgentHelperErrorEventArgs = LoadResourceAgentHelperErrorEventArgs.Create(LoadResourceStatus.AssetError, GameFramework.Utility.Text.Format("Scene name '{0}' is invalid.", assetName));
                    m_LoadResourceAgentHelperErrorEventHandler(this, loadResourceAgentHelperErrorEventArgs);
                    GameFramework.ReferencePool.Release(loadResourceAgentHelperErrorEventArgs);
                    return;
                }
        ...
        private void UpdateUnityWebRequest()
        {
            if (m_UnityWebRequest != null)
            {
...
#endif
                        LoadResourceAgentHelperErrorEventArgs loadResourceAgentHelperErrorEventArgs = LoadResourceAgentHelperErrorEventArgs.Create(LoadResourceStatus.NotExist, GameFramework.Utility.Text.Format("Can not load asset bundle '{0}' with error message '{1}'.", m_BytesFullPath, isError ? m_UnityWebRequest.error : null));
                        m_LoadResourceAgentHelperErrorEventHandler(this, loadResourceAgentHelperErrorEventArgs);
                        GameFramework.ReferencePool.Release(loadResourceAgentHelperErrorEventArgs);
                    }
                }
                else if (m_UnityWebRequest.downloadProgress != m_LastProgress)
                {
                    ...
                    GameFramework.ReferencePool.Release(loadResourceAgentHelperUpdateEventArgs);
                }
            }
        }
#else
            ...
            if (m_FileAssetBundleCreateRequest != null)
            {
                if (m_FileAssetBundleCreateRequest.isDone)
                {
                    ...
                    if (assetBundle != null)
                    {
                        ...
                        GameFramework.ReferencePool.Release(loadResourceAgentHelperReadFileCompleteEventArgs);
                    ...
                    {
                        LoadResourceAgentHelperErrorEventArgs loadResourceAgentHelperErrorEventArgs = LoadResourceAgentHelperErrorEventArgs.Create(LoadResourceStatus.NotExist, GameFramework.Utility.Text.Format("Can not load asset bundle from file '{0}' which is not a valid asset bundle.", m_FileName == null ? m_FileFullPath : GameFramework.Utility.Text.Format("{0} | {1}", m_FileFullPath, m_FileName)));
                        m_LoadResourceAgentHelperErrorEventHandler(this, loadResourceAgentHelperErrorEventArgs);
                        GameFramework.ReferencePool.Release(loadResourceAgentHelperErrorEventArgs);
                    }
                }
            ...
            if (m_BytesAssetBundleCreateRequest != null)
            {
                if (m_BytesAssetBundleCreateRequest.isDone)
                {
                    ...
                    if (assetBundle != null)
                    {
                        ...
                        GameFramework.ReferencePool.Release(loadResourceAgentHelperParseBytesCompleteEventArgs);
            ...
            if (m_AssetBundleRequest != null)
            {
                if (m_AssetBundleRequest.isDone)
                {
                    if (m_AssetBundleRequest.asset != null)
                    {
                        ...
                        GameFramework.ReferencePool.Release(loadResourceAgentHelperLoadCompleteEventArgs);
                        m_AssetName = null;
                        m_LastProgress = 0f;
                        m_AssetBundleRequest = null;
                    }
                    ...
                    {
                        LoadResourceAgentHelperErrorEventArgs loadResourceAgentHelperErrorEventArgs = LoadResourceAgentHelperErrorEventArgs.Create(LoadResourceStatus.AssetError, GameFramework.Utility.Text.Format("Can not load asset '{0}' from asset bundle which is not exist.", m_AssetName));
                        m_LoadResourceAgentHelperErrorEventHandler(this, loadResourceAgentHelperErrorEventArgs);
                        GameFramework.ReferencePool.Release(loadResourceAgentHelperErrorEventArgs);
                    }
                }
        ...
        private void UpdateAsyncOperation()
        {
            if (m_AsyncOperation != null)
            {
                if (m_AsyncOperation.isDone)
                {
                    ...
                    {
                        LoadResourceAgentHelperErrorEventArgs loadResourceAgentHelperErrorEventArgs = LoadResourceAgentHelperErrorEventArgs.Create(LoadResourceStatus.AssetError, GameFramework.Utility.Text.Format("Can not load scene asset '{0}' from asset bundle.", m_AssetName));
                        m_LoadResourceAgentHelperErrorEventHandler(this, loadResourceAgentHelperErrorEventArgs);
                        GameFramework.ReferencePool.Release(loadResourceAgentHelperErrorEventArgs);
                    }
                }
