...
namespace GameFramework.UnityRuntime.Resource
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_ResourceHelperTypeName = "GameFramework.UnityRuntime.DefaultResourceHelper";

        [SerializeField]
        private ResourceHelperBase m_CustomResourceHelper = null;

        [SerializeField]
        private string m_LoadResourceAgentHelperTypeName = "GameFramework.UnityRuntime.DefaultLoadResourceAgentHelper";
        ...
        private void AddLoadResourceAgentHelper(int index)
        {
            ...
            loadResourceAgentHelper.name = GameFramework.Utility.Text.Format("Load Resource Agent Helper - {0}", index.ToString());
