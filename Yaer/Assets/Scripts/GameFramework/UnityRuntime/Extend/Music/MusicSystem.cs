...
using GameFramework.UnityRuntimeExtend.Resource.UnityResources;
using UnityEngine;
using Object = UnityEngine.Object;

namespace GameFramework.UnityRuntimeExtend.Music
{
    ...
    public class MusicSystem : BaseSingleton<MusicSystem>
    {
        ...
        public MusicSystem()
        {
            MonoSystem.Instance.AddUpdateEvent(UpdateSound);
        ...
        public void PlayMusic(string path, float volume, bool isLoop)
        {
            ...
            // 异步加载音乐文件并播放
            ResourcesSystem.Instance.LoadAsync<AudioClip>(path, ac =>
            {
        ...
        // 音效播放
        public void PlaySound(string path, float volume, bool isLoop, Action callBack = null)
        {
