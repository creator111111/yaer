...
namespace GameFramework.UnityRuntime.Base
{
    ...
    public sealed class BaseComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_VersionHelperTypeName = "GameFramework.UnityRuntime.DefaultVersionHelper";

        [SerializeField]
        private string m_LogHelperTypeName = "GameFramework.UnityRuntime.DefaultLogHelper";

        [SerializeField]
        private string m_CompressionHelperTypeName = "GameFramework.UnityRuntime.DefaultCompressionHelper";

        [SerializeField]
        private string m_JsonHelperTypeName = "GameFramework.UnityRuntime.DefaultJsonHelper";
        ...
        private void InitVersionHelper()
        {
            ...
            Type versionHelperType = GameFramework.Utility.Assembly.GetType(m_VersionHelperTypeName);
            if (versionHelperType == null)
            {
                throw new GameFrameworkException(GameFramework.Utility.Text.Format("Can not find version helper type '{0}'.", m_VersionHelperTypeName));
            }
            ...
            {
                throw new GameFrameworkException(GameFramework.Utility.Text.Format("Can not create version helper instance '{0}'.", m_VersionHelperTypeName));
            }
        ...
        private void InitLogHelper()
        {
            ...
            {
                throw new GameFrameworkException(GameFramework.Utility.Text.Format("Can not find log helper type '{0}'.", m_LogHelperTypeName));
            }

            GameFrameworkLog.ILogHelper logHelper = (GameFrameworkLog.ILogHelper)Activator.CreateInstance(logHelperType);
            if (logHelper == null)
            {
                throw new GameFrameworkException(GameFramework.Utility.Text.Format("Can not create log helper instance '{0}'.", m_LogHelperTypeName));
            }
        ...
        private void InitCompressionHelper()
        {
            ...
            Type compressionHelperType = GameFramework.Utility.Assembly.GetType(m_CompressionHelperTypeName);
            ...
            GameFramework.Utility.Compression.ICompressionHelper compressionHelper = (GameFramework.Utility.Compression.ICompressionHelper)Activator.CreateInstance(compressionHelperType);
            ...
            GameFramework.Utility.Compression.SetCompressionHelper(compressionHelper);
        }
