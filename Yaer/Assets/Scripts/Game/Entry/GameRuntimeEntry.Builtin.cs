...
using GameFramework.UnityRuntime.Config;
using GameFramework.UnityRuntime.DataNode;
using GameFramework.UnityRuntime.DataTable;
using GameFramework.UnityRuntime.Debugger;
using GameFramework.UnityRuntime.Download;
using GameFramework.UnityRuntime.Entity;
using GameFramework.UnityRuntime.Event;
using GameFramework.UnityRuntime.FileSystem;
using GameFramework.UnityRuntime.Fsm;
using GameFramework.UnityRuntime.Localization;
using GameFramework.UnityRuntime.Network;
using GameFramework.UnityRuntime.ObjectPool;
using GameFramework.UnityRuntime.Procedure;
...
using GameFramework.UnityRuntime.WebRequest;
...
namespace Game.Entry
{
    ...
    /// 游戏入口。
    /// </summary>
    public partial class GameRuntimeEntry
    {
        /// <summary>
        /// 获取游戏基础组件。
        /// </summary>
