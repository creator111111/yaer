...
namespace Game.GameRuntime.GameSceneManager.Scene.WestRappRoad
{
    public class WestRappRoadSceneMgr : BaseGameSceneManager
    {
        public override void OnInit()
        {
            base.OnInit();

            GetModule<PlayerHandlerComponentGSM>().SetNowPlace(SceneName.WestRappRoad);
        }
        ...
        public override void OnExitScene()
        {
            ...
            var storyEvent = WestRappRoadBossBattleMgr.getInstance().GetBossBattleStory();
            if (storyEvent != null)
            {
