...
{
    /// <summary>
    /// 肯姆尼民居 <see cref="SceneName.Village_HomeScene45"/> 室内场景管理器。
    ...
    /// 且可能 NRE 取 HomeScene1Xiaer）→ 进屋黑屏。禁止改龙宫 Manager 将就村屋。
    /// 曾用磁盘名 Village_HomeScene3；2026-08-20 改名 45，与村门 House_Npc45 对齐。
    /// </remarks>
    public class Village_HomeScene45SceneManager : BaseGameSceneManager
    {
        public override void OnInit()
        {
            ...
            nowSceneName = SceneName.Village_HomeScene45;
        ...
        public override void OnEnterScene()
        {
            ...
            Debug.Log($"[VillageHomeScene45Debug] lastScene={lastScene} place={PlaceName.KenMuNi}");
        }
