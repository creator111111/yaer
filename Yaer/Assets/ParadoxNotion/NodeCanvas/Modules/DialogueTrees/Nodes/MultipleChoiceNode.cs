...
namespace NodeCanvas.DialogueTrees
{
    ...
    public class MultipleChoiceNode : DTNode
    {
        ...
        void DoChoiceGUI(Choice choice) {
            ...
            choice.statement.text_en = UnityEditor.EditorGUILayout.TextField(choice.statement.text_en);
            UnityEditor.EditorGUILayout.LabelField("日文文本", EditorStyles.boldLabel);
            choice.statement.text_jp = UnityEditor.EditorGUILayout.TextField(choice.statement.text_jp);
